...
class Service(models.Model):
    prestataire = models.ForeignKey('users.PrestataireProfile', on_delete=models.CASCADE, related_name='service_listings')
    ...
    def __str__(self):
        return f"Service #{self.id} - {self.prestataire.company_name} - {self.category.nom}"
