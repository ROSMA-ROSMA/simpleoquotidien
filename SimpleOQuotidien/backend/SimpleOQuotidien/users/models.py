...
class NotificationTypeChoices(models.TextChoices):
    PROVIDER_ASSIGNED = 'PROVIDER_ASSIGNED', 'Prestataire assigné'
    PROVIDER_RESPONSE = 'PROVIDER_RESPONSE', 'Réponse du prestataire'
    REASSIGNMENT_NEEDED = 'REASSIGNMENT_NEEDED', 'À réassigner'
...
class Notification(models.Model):
    ...
    order = models.ForeignKey('commandes.Order', on_delete=models.CASCADE, related_name='notifications', null=True, blank=True)
    ...
    def __str__(self):
        return f"Notification #{self.id} pour {self.user.email}"