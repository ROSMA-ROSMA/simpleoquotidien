...
from .models import Assignment, Notes, Notification, PrestataireProfile, Subscription, Utilisateur
...
class AssignmentInline(TabularInline):
    ...
    fk_name = 'prestataire'
    extra = 0
    fields = ('order', 'methode', 'status', 'qualifier', 'date_creation')
    readonly_fields = ('date_creation',)
...
class AssignmentAdmin(ModelAdmin):
    list_display = ('id', 'order', 'prestataire', 'qualifier', 'methode', 'status_badge', 'date_creation')
...
class NotificationAdmin(ModelAdmin):
    list_display = ('id', 'user', 'type', 'title', 'is_read', 'date_creation')
